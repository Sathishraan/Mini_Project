...
const Footer = () => {
    return (
        <footer className=" text-white  py-10 md:mt-16 px-5 max-w-full bg-white mx-auto rounded-lg">
            <div className="grid gap-10 space-x-20 md:pl-20 bg-white md:grid-cols-4">
                ...
                <div className="col-span-full bg-white p-5 rounded-lg text-center">
                    <h2 className="text-4xl text-black bg-white font-bold">Subscribe to newsletter</h2>
                    <div className="flex md:pt-8 bg-white justify-center mt-2">
                        ...
                        />
                        <button className="p-2 bg-green-600 text-black rounded-r-md cursor-pointer">
                ...
                <div className='text-black bg-white'>
                    ...
                    <p className="mt-2  bg-white">We're Providing Everyday Fresh and Quality Products.</p>
                ...
                <div className='text-black bg-white'>
                    ...
                    <p className="mt-2 bg-white">GCT opposite, Thadagam Road, Coimbatore - 641013</p>
            ...
            <div className="border-t text-black bg-white border-white mt-5 pt-5 flex flex-col md:flex-row items-center justify-between text-center">
                ...
                <div className="flex  bg-white space-x-4 mt-3 md:mt-0">
                    <a href="#" className="hover:underline bg-white ">Terms & Conditions</a>
                    <a href="#" className="hover:underline  bg-white">Privacy Policy</a>
                    <a href="#" className="hover:underline  bg-white">Support</a>
                </div>
            </div>
        </footer>
    );
